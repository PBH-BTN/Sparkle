...
//                    )
        ...
        Set<AnalysedRule> untrustedIps = new HashSet<>();
        filterIP(ipTries).forEach(ip -> untrustedIps.add(new AnalysedRule(null, ip.toString(), UNTRUSTED_IP, "Auto Generated by Sparkle")));
    ...
    public void cronHighRiskIps() {
        ...
        var highRiskIps = ipMerger.merge(filtered).stream().map(ip -> new AnalysedRule(null, ip, HIGH_RISK_IP, "Auto Generated by Sparkle")).collect(Collectors.toSet());
...
//    }
    ...
    public void cronUpdateTrunkerFile() {
        ...
        var filtered = filterIP(ipTries);
        var ips = ipMerger.merge(filtered).stream().map(ip -> new AnalysedRule(null, ip, TRACKER_HIGH_RISK, "Auto Generated by Sparkle")).collect(Collectors.toSet());
    ...
    public void cronUpdateOverDownload() throws InterruptedException {
        ...
        Set<AnalysedRule> rules = new HashSet<>();
        ipMerger.merge(ipTries).forEach(i -> rules.add(new AnalysedRule(null, i, OVER_DOWNLOAD, "Auto Generated by Sparkle")));
