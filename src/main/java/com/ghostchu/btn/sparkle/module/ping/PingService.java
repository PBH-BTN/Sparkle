...
public class PingService {
    ...
    public BtnRule generateBtnRule() {
        ...
        entities.addAll(untrustedIps.stream().map(ip -> new RuleDto(0L, "BTN-AutoGenerated-UntrustedIP", "peerIp", ip.getHostAddress(), System.currentTimeMillis(), System.currentTimeMillis())).toList());
