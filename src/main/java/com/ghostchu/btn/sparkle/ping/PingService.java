...
import com.ghostchu.btn.sparkle.banhistory.BanHistoryService;
import com.ghostchu.btn.sparkle.banhistory.internal.BanHistory;
import com.ghostchu.btn.sparkle.clientdiscovery.ClientDiscoveryService;
import com.ghostchu.btn.sparkle.clientdiscovery.ClientIdentity;
...
import com.ghostchu.btn.sparkle.rule.RuleDto;
import com.ghostchu.btn.sparkle.rule.RuleService;
import com.ghostchu.btn.sparkle.snapshot.SnapshotService;
...
public class PingService {
    ...
    public BtnRule generateBtnRule() {
        ...
        entities.addAll(untrustedIps.stream().map(ip -> new RuleDto(0L, "BTN-AutoGenerated-UntrustedIP", "ip", ip.getHostAddress(), System.currentTimeMillis(), System.currentTimeMillis())).toList());
